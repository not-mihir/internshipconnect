    ...
    return (
      <>
        <nav id="navbar-example2" class="navbar navbar-dark bg-dark text-light">
          Internship Connect Documentation
          <ul class="nav">
            <li class="nav-item">
          ...
          <div className="row mt-3">
            <div className="col-sm-12">
              ...
              >
                ...
                <div>
                  Internship Management System for DA-IICT. This web application is
                ...
                <div>
                  ...
                  <ul className="ml-4">
                    ...
                    <li>
                      <code>EMAILFROM</code> stores the Email ID for the DA-IICT
